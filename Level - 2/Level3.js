export default class Level3 extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image('car2', 'images/level3/car.jpg');
        this.load.image('smoke', 'images/smoke.jpg');
        this.load.image('smoking', 'images/level3/smoking.jpg')
        this.load.image('pedal', 'images/level3/solar.jpg')
        this.load.image('plant', 'images/level3/plant.webp')
