class Planet4Level2 extends Phaser.Scene {
    constructor() {
        super({ key: 'Planet4Level2' });
    ...
    preload() {
        this.load.image('level2-bg', 'assets/planet4/level2/level2.avif');
        this.load.audio('click', 'assets/planet4/music/click.wav');
        this.load.image('player', 'assets/planet4/player.webp');
        this.load.image('tree', 'assets/planet4/level2/tree.png');
        this.load.image('cactus', 'assets/planet4/level2/cactus.png');
        this.load.image('shrub', 'assets/planet4/level2/shrub.png');
        this.load.image('grass', 'assets/planet4/level2/grass.png');
        this.load.image('flower', 'assets/planet4/level2/flower.png');
        this.load.audio('introAudio', 'assets/planet4/music/level2/into.mp3');
        this.load.audio('congratsAudio', 'assets/planet4/music/level2/congrats.mp3');
        this.load.audio('warningAudio', 'assets/planet4/music/level2/lap.mp3');
    }
    ...
    cleanupAndTransition() {
        ...
        this.scene.start('TransitionScene', { nextScene: 'Planet4Level3' });
    }
