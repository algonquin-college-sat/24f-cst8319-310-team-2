class Planet4Level1 extends Phaser.Scene {
    ...
    preload() {
        this.load.image('level-bg', 'assets/planet4/level1.jpg');
        this.load.audio('click', 'assets/planet4/music/click.wav');
        this.load.image('player', 'assets/planet4/player.webp');
        this.load.image('factory', 'assets/planet4/factory.avif');
        this.load.image('car', 'assets/planet4/car.webp');
        this.load.image('smoke', 'assets/planet4/smoke.jpg');
        this.load.image('bioplant', 'assets/planet4/bioplant.jpg')
        this.load.image('burn', 'assets/planet4/burning.avif')
        this.load.image('construction', 'assets/planet4/construction.jpg')

        this.load.audio('burnExplanation', 'assets/planet4/music/level1/burn.mp3');
        this.load.audio('carExplanation', 'assets/planet4/music/level1/car.mp3');
        this.load.audio('factoryExplanation', 'assets/planet4/music/level1/factory.mp3');
        this.load.audio('start1', 'assets/planet4/music/level1/start1.mp3');
        this.load.audio('bioplantExplanation', 'assets/planet4/music/level1/biomass.mp3');
        this.load.audio('constructionExplanation', 'assets/planet4/music/level1/construction.mp3');
        this.load.audio('finish', 'assets/planet4/music/level1/level2complete.mp3');
        this.load.audio('restart', 'assets/planet4/music/level1/level2restart.mp3');
          ...
          onComplete: () => {
              ...
              const transitionHandler = () => {
                  ...
                  this.time.delayedCall(500, () => {
                      this.scene.start('TransitionScene', { nextScene: 'Planet4Level2' });
                  });
              };
              ...
              this.input.once('pointerdown', () => {
                  ...
                  this.tweens.add({
                      ...
                      onComplete: () => {
                        this.sound.play('click');
                          this.cleanup();
                          this.scene.start('TransitionScene', { nextScene: 'Planet4Level1' });
                      }
                  });
              });
          }
